...
const LABELS = {
        ru: 
        {
            grammar: {nominative: "Грамматика"},
            vocabulary: {nominative: "Лексика"},
            informal: {nominative: "Разговорная речь"},
            beginner: {nominative: "Начинающие"},
            intermediate: {nominative: "Средний уровень"},
            ...
            kazan: {nominative: "Казань", prepositional: "Казани"},
            kemerovo: {nominative: "Кемерово", prepositional: "Кемерово"},
        ...
        en:
        {
            grammar: {nominative: "grammar"},
            vocabulary: {nominative: "vocabulary"},
            informal: {nominative: "informal"},
            beginner: {nominative: "beginner"},
            intermediate: {nominative: "intermediate"},
            ...
            kazan: {nominative: "Kazan"},
            kemerovo: {nominative: "Kemerovo"},
